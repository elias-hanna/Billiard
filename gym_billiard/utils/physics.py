...
class PhysicsSim(object):
  ...
  def _create_cue(self, cue_position=None, cue_angle=None):
    ...
    jointW0 = self.world.CreatePrismaticJoint(bodyA=self.walls[3],
                                              ...
                                              anchor=self.walls[3].worldCenter,
                                              axis=axis,
                                              lowerTranslation=-self.params.CUE_DISTANCE_TO_BALL-self.params.CUE_THROUGH_DISTANCE,
                                              upperTranslation=self.params.CUE_DISTANCE_TO_BALL+self.params.CUE_THROUGH_DISTANCE,
                                              enableLimit=True,
